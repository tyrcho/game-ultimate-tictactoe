...
public class Referee extends AbstractReferee {
  ...
  public Properties init(Properties params) {
    try {
      ...
      final Field firstTurnMaxTime = GameManager.class.getDeclaredField("firstTurnMaxTime");
      firstTurnMaxTime.setAccessible(true);
      firstTurnMaxTime.set(gameManager, 100_000);
    } catch (Exception e) {
      random = new Random(0);
    }
  ...
  public void gameTurn(int turn) {
    ...
    gameManager.setTurnMaxTime(10000000);
